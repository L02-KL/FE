...
export function getCourseIcon(iconType: CourseIconType, size: number = 28, color: string = '#FFFFFF') {
  switch (iconType) {
    case 'calculator':
    ...
    case 'atom':
      return <MaterialCommunityIcons name="atom" size={size} color={color} />;
    case 'code':
      ...
      <View style={styles.details}>
        ...
        <View style={styles.infoRow}>
          <View style={styles.infoItem}>
            <Text style={[styles.infoLabel, { color: colors.textMuted }]}>Semester</Text>
            <Text style={[styles.infoValue, { color: colors.textPrimary }]}>{course.semester || 'N/A'}</Text>
          </View>
          <View style={styles.infoItem}>
            <Text style={[styles.infoLabel, { color: colors.textMuted }]}>Instructor</Text>
            <Text style={[styles.infoValue, { color: colors.textPrimary }]}>{course.instructor || 'N/A'}</Text>
          </View>
        </View>
        ...
        <View style={styles.badgeRow}>
          <View style={[styles.badge, { backgroundColor: '#E8F5E9' }]}>
            <Text style={[styles.badgeText, { color: '#4CAF50' }]}>{course.activeTaskCount} active</Text>
          </View>
          <View style={styles.doneBadge}>
            <Text style={styles.checkIcon}>✅</Text>
            <Text style={[styles.doneText, { color: colors.textSecondary }]}>{course.completedTaskCount} done</Text>
          </View>
        </View>
