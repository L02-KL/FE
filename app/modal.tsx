...
export default function AddTaskModal() {
    ...
    const scheduleLocalNotification = async (
        ...
        const triggerDate = new Date(
            due.getTime() - reminderOffset * 60 * 1000
        );
        ...
        try {
            await Notifications.scheduleNotificationAsync({
                content: {
                    title: "⏰ Task Reminder",
                    body: `"${taskTitle}" is due in ${selectedReminder?.label.replace(
                        " before",
                        ""
                    )}!`,
                    data: { taskId },
                    ...
                    {options.map((option) => (
                        <TouchableOpacity
                            ...
                            style={[
                                ...
                                (option.key || option.id) === selectedValue && {
