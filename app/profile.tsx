      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.sectionContent, { backgroundColor: colors.cardBackground }]}>
            {renderField('Full Name', profile.name, 'name', 'person-outline')}
            {renderField('Email', profile.email, 'email', 'mail-outline')}
            {renderField('Phone', profile.phone, 'phone', 'call-outline')}
          </View>
        </View>

        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: colors.textMuted }]}>Academic Information</Text>
          <View style={[styles.sectionContent, { backgroundColor: colors.cardBackground }]}>
            {renderField('Student ID', profile.studentId, 'studentId', 'id-card-outline', false)}
            {renderField('Major', profile.major, 'major', 'school-outline', false)}
            {renderField('Year', profile.year, 'year', 'calendar-outline', false)}
          </View>
        </View>
