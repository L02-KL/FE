      ...
      >
        ...
        <View style={styles.section}>
          ...
          <View style={styles.featureItem}>
            ...
            <Text style={styles.featureText}>24/7 Access to Professional Psychologists</Text>
          </View>
          <View style={styles.featureItem}>
            <Ionicons name="checkmark-circle" size={20} color={Colors.success} />
          ...
          <View style={styles.featureItem}>
            <Ionicons name="checkmark-circle" size={20} color={Colors.success} />
            <Text style={styles.featureText}>Mood Tracking & Mental Health Assessments</Text>
          </View>
          <View style={styles.featureItem}>
            <Ionicons name="checkmark-circle" size={20} color={Colors.success} />
